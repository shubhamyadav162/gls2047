      ...
      <div class="col-md-12">
        <div class="card">
          <div class="card-header">
            <h4 class="card-title"><?php if(isset( $_GET['type'])){echo $_GET['type'];}?> Downloads</h4>
          </div>
          <div class="card-body">
            <a class="text-primary" href="downloads.php">All</a> | 
            <!-- <a class="text-primary" href="downloads.php?status=1">Active</a> | 
            <a class="text-primary" href="downloads.php?status=2">Blocked</a> |  -->
            <a class="text-primary" href="downloads.php?type=Brochure">Brochure</a> | 
            <a class="text-primary" href="downloads.php?type=Floor Plan">Floor Plan</a> | 
            <a class="text-primary" href="downloads.php?type=Post Show">Post Show Report</a>
                ...
                <tbody>
                  <?php 
                    if($_GET['type']){
                      ...
                      $sql="SELECT * from query where subject like '%download%' order by status ASC, id DESC"; 
                    }
                  ...
                  ?>
                    <tr>
                      ...
                      <td style="width:80px !important;">
                        <a class="text-success" href="downloads.php?st=1&id=<?php echo $row['id'];?>">Active</a> | 
                        <a class="text-warning" href="downloads.php?st=2&id=<?php echo $row['id'];?>">Block</a> | 
                        <a class="text-danger" href="downloads.php?st=3&id=<?php echo $row['id'];?>">Delete</a>
                      </td>
                    </tr>
                  <?php } }?> 
                </tbody>
