      ...
      <div class="col-md-12">
        <div class="card">
          <div class="card-header">
            <h4 class="card-title"><?php echo $_GET['type'];?> Enquiry</h4>
          </div>
          <div class="card-body">
            <a class="text-primary" href="enquiry.php">All</a> | 
            <a class="text-primary" href="enquiry.php?status=1">Active</a> | 
            <a class="text-primary" href="enquiry.php?status=2">Blocked</a> | 
            <a class="text-primary" href="enquiry.php?typetype=Brochure">Brochure</a> | 
            <a class="text-primary" href="enquiry.php?type=Floor Plan">Floor Plan</a> | 
            <a class="text-primary" href="enquiry.php?type=Post Show">Post Show Report</a>
                  ...
                  ?>
                    <tr>
                      ...
                      <td style="width:80px !important;">
                        <a class="text-success" href="enquiry.php?st=1&id=<?php echo $row['id'];?>">Active</a> | 
                        <a class="text-warning" href="enquiry.php?st=2&id=<?php echo $row['id'];?>">Block</a> | 
                        <a class="text-danger" href="enquiry.php?st=3&id=<?php echo $row['id'];?>">Delete</a>
                      </td>
                    </tr>
                  <?php } }?> 
                </tbody>
