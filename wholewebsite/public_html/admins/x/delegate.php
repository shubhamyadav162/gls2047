<?php 
  ...
  if(!empty($_GET['st'])){
    ...
    $conn->query($sql);
    header("location:http://localhost/iconex/globalhse.org/myadmin/exhibitor.php");
?>
<meta http-equiv="refresh" content="1; url=delegate.php">
<?php } ?>
<style type="text/css">
  ...
  .display > thead > tr > th{border:1px solid #ddd !important;padding:10px 2px 10px 2px !important;overflow-x:hidden;white-space:wrap;}
  .display > tbody > tr > td{border:1px solid #ddd !important;padding:2px !important;overflow-x:hidden;white-space:wrap;}
</style>
<div class="container">
          ...
          <div class="card-body">
            <div class="table-responsive" style="max-height:450px !important;overflow:auto;">
              <table id="export_table" class="display table table-striped table-hover table-bordered">
                ...
                <tbody style="">
                  <?php 
                    $sql="SELECT * from registerFinalnowform order by id DESC"; 
                  ...
                  ?>
                    <tr>
                      ...
                      <td><?php if($row['date']>'0000-00-00 00:00:00'){echo date('Y-m-d h:iA',strtotime($row['date']));}?></td>
                      ...
                      <td style="width:80px !important;">
                        <a class="text-success" href="delegate.php?st=1&id=<?php echo $row['id'];?>">Active</a> | 
                        <a class="text-warning" href="delegate.php?st=2&id=<?php echo $row['id'];?>">Block</a> | 
                        <a class="text-danger" href="delegate.php?st=3&id=<?php echo $row['id'];?>">Delete</a>
                      </td>
                    </tr>
                  <?php } }?>
                </tbody>
