<?php
  ...
  // ---- PRODUCT PRICING ----
  $products = [
    "PremiumIIT Pass"     => 12500,//25
    "PremiumNonIIT Pass"  => 17500,//35
                ...
                <body style='font-family:Segoe UI, Arial; background:#f4f7fb; margin:0; padding:30px;'>
                  <div style='max-width:700px; margin:auto; background:#fff; border-radius:10px; overflow:hidden; box-shadow:0 3px 15px rgba(0,0,0,0.1);'>
                    <div style='background:#003399; color:#fff; padding:25px; text-align:center;'>
                      <h2 style='margin:0;'>Global Leadership Summit Vision 2047 | Delegate Registration</h2>
                      <p style='margin:0;font-size:14px;'>Official Registration Confirmation</p>
                    </div>
                    <div style='padding:30px;'>
                      <p>Dear <b>$name</b>,</p>
                      <p>Thank you for registering to participate in Global Leadership Summit Vision 2047 scheduled for 18 – 19 July 2026 at Yashobhoomi Convention Centre, New Delhi.</p><br/>
                      <p>Please collect your registration badge from the onsite registration counter on 18 July 2026 0800 hrs onwards. <br/>We look forward to welcoming you to Global Leadership Summit Vision 2047.</p><br/>
                      <p>For assistance, please write to <b>secretariat@glsvision2047.com</b></p><br/>
                      <p>Warm Regards,<br/>
                      <b>Global Leadership Summit Vision 2047</b><br/>
                      Tel No. +91 7291 907 708<br/><br/><br/></p>
                    </div>
                    <div style='background:#f8f9fa; padding:15px; text-align:center; font-size:13px; color:#666;'>
                      <p style='margin:0;'>©️ ".date('Y')."-".(date('Y')+1)." Global Leadership Summit Vision 2047 | ".ORG_ADDRESS."</p>
