...
export default function HeroSection() {
  return (
    <section id="home" className="relative min-h-screen flex items-center overflow-hidden">
      ...
      <div className="relative container-gls pt-24 pb-16 md:pt-40 md:pb-28">
        <div className="max-w-4xl mx-auto text-center md:text-left md:mx-0">
          <p className="label-upper text-gold-muted mb-4 md:mb-6 animate-fade-in text-[10px] md:text-sm">18–19 July 2026 • Yashobhoomi Convention Centre • New Delhi, India</p>
          ...
          <p className="text-lg md:text-2xl text-ivory/80 font-light leading-relaxed mb-4 max-w-2xl mx-auto md:mx-0 animate-fade-in-up" style={{ animationDelay: "0.2s" }}>
            India's most consequential gathering of leaders, innovators & nation-builders
          </p>
          <p className="text-sm md:text-base text-ivory/60 leading-relaxed mb-10 max-w-2xl mx-auto md:mx-0 animate-fade-in-up" style={{ animationDelay: "0.3s" }}>
            A national platform where leadership, capital, governance, and innovation converge to shape India's future.
          </p>

          <div className="flex flex-col sm:flex-row items-center justify-center md:justify-start gap-4 mb-16 animate-fade-in-up" style={{ animationDelay: "0.4s" }}>
